package com.tasdev.carparkingandrepair.SearchActivity;
...
import com.tasdev.carparkingandrepair.Home.HomeActivity;
import com.tasdev.carparkingandrepair.Model.FetchURL;
import com.tasdev.carparkingandrepair.Model.SearchDataModel;
import com.tasdev.carparkingandrepair.Model.TaskLoadedCallback;
import com.tasdev.carparkingandrepair.R;
...
public class SearchRouteActivity extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    public void GoToMarketHome(View view) {
        startActivity(new Intent(SearchRouteActivity.this,HomeActivity.class));
        SearchRouteActivity.this.overridePendingTransition(0,0);
    }
...
//                MarkerOptions markerOptions = new MarkerOptions();
                ...
                markerOptions.title(name + " : " + vicinity + " : " +new DecimalFormat("##.##").format( distance)+ " Km");
